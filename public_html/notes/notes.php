<!DOCTYPE html>
    <head>
        ...
        $body='<!DOCTYPE html><head><title>'.$title.'</title><link rel="stylesheet" href="../styles.css"><link rel="stylesheet" href="../katex.min.css"><script src="../katex.js"></script></head><body><div id="container"><div id="top"><img style="float:right;padding-right:20px;" src="cat.gif" /><div id="title"><h1>'.$title.'</h1></div></div><div id="top_nav"><a class="top_nav" href="formal_language/">Formal</a><a class="top_nav" href="logic/">Logic</a><a class="top_nav" href="lambda/">Lambda</a><a class="top_nav" href="types/">Types</a></div><div id="cardHolder"><center><img src="cat2.gif" /><img src="cat2.gif" /><img src="cat3.gif" /></center></div><div id="textArea"></div><script>try{katex.render("'.$input.'",textArea);} catch(err){}</script><div id="bottom"><br> Thanks for checking out my mafff and pergrehming sight.<p class="copyright">Copyright &copy; 2017 and beyond</p></div></div></body></html>';
            fwrite($myFile,$body);
            fclose($myFile);            
        ?>
    </head>
